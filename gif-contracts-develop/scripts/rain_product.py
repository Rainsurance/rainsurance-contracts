...
RISKPOOL_NAME = 'RainRiskpool'
ORACLE_NAME = 'RainOracle'
PRODUCT_NAME = 'RainProduct'

class GifRainRiskpool(object):
    ...
    def __init__(self, 
        ...
        self.riskpool = RainRiskpool.deploy(
            s2b32(name),
            collateralization,
            erc20Token,
            riskpoolWallet,
    ...
    def getContract(self) -> RainRiskpool:
        return self.riskpool


class GifRainOracle(object):
    ...
    def getContract(self) -> RainOracle:
        return self.oracle


class GifRainProduct(object):
    ...
    def __init__(self, 
        ...
        insurer: Account, 
        oracle: GifRainOracle, 
        riskpool: GifRainRiskpool, 
        name=PRODUCT_NAME, 
        publishSource=False
    ):
        ...
        self.product = RainProduct.deploy(
            s2b32(name),
            registry,
            erc20Token.address,
            oracle.getId(),
    ...
    def getOracle(self) -> GifRainOracle:
        return self.oracle

    def getRiskpool(self) -> GifRainRiskpool:
        return self.riskpool
    
    def getContract(self) -> RainProduct:
        return self.product
...
class GifRainProductComplete(object):
    ...
    def getProduct(self) -> GifRainProduct:
        return self.product
